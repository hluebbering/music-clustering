...
user_id = "hannahluebbering"                         # Spotify user ID.
playlist_uri = "spotify:playlist:28wG2XQh6rJkUtJyNFfd0z" 
client = "4cf3afdca2d74dc48af9999b1b7c9c61"                        # Spotify client ID.
secret = "f6ca08ad37bb41a0afab5ca1dc74b208"                    # Spotify client secret.
neo4j_url = "bolt://44.193.2.117:7687"                                # url of the neo4j database.
neo4j_username = "neo4j"                                            # neo4j username. defaults to 'neo4j'.
neo4j_password = "peacetime-messes-labors"                                              # neo4j password.
